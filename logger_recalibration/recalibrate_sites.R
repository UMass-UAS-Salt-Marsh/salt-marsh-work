...
# for (i in seq_len(nrow(sites))) {
   ...
   # Plots spatial logger error (red means mean_wse_diff is closer to 0):
   ...
   p2 <- plot_high_tides(selected_files, common_high_tides = common_high_tides, deployments = deployments)
   print(p2)
